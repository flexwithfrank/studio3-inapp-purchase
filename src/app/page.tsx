    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <div className="text-center sm:text-left max-w-md">
          ...
          <p className="mb-6">Experience the best workouts with Studio3. Join our community and transform your fitness journey today.</p>
        </div>
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
        <p className="text-sm text-gray-500">© {new Date().getFullYear()} Studio3. All rights reserved.</p>
      </footer>
    </div>
  );
}
